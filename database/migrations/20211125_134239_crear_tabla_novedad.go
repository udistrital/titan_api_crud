...
func (m *CrearTablaNovedad_20211125_134239) Up() {
	...
	//m.SQL("COMMENT ON TABLE liquidador.novedad.id IS 'Identificador de la tabla novedad';")
	//m.SQL("COMMENT ON TABLE liquidador.novedad.valor IS 'Almacena el valor de la novedad, si es fijo almacena el valor mensual de la cuota, si es fijo almacena el porcentaje correspondiente';")
	//m.SQL("COMMENT ON TABLE liquidador.novedad.cuotas IS 'Almacena el númeor de cuotas de la novedad';")
	//m.SQL("COMMENT ON TABLE liquidador.novedad.concepto_nomina_id IS 'Id del concepto al cual está asociada la novedad';")
