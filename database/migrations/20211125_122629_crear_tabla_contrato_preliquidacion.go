...
func (m *CrearTablaContratoPreliquidacion_20211125_122629) Up() {
	...
	m.SQL("COMMENT ON COLUMN liquidador.contrato.id IS 'Identificador unico de la tabla contrato_preliquidacion.';")
}
