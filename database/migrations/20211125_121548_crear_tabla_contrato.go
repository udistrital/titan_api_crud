...
func (m *CrearTablaContrato_20211125_121548) Up() {
	...
	m.SQL("COMMENT ON COLUMN liquidador.contrato.rp IS 'Registro presupuestal del contrato.';")
	m.SQL("COMMENT ON COLUMN liquidador.contrato.cdp IS 'Certificado de Disponibilidad el contrato';")
