...
func (m *CrearTablaDetallePreliquidacion_20211125_124020) Up() {
	...
	m.SQL("COMMENT ON TABLE liquidador.detalle_preliquidacion.id IS 'Identificador de la tabla detalle_preliquidacion';")
	m.SQL("COMMENT ON TABLE liquidador.detalle_preliquidacion.concepto_nomina_id IS 'Asocia el detalle al concepto al que pertenece';")
	m.SQL("COMMENT ON TABLE liquidador.detalle_preliquidacion.valor_calculado IS 'El valor calculado para el concepto';")
}
