...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/titan_api_crud/controllers:NovedadController"] = append(beego.GlobalControllerRouter["github.com/udistrital/titan_api_crud/controllers:NovedadController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
